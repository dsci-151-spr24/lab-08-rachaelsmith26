...
1.  Visualize the distribution of `score`.
    ...
    ***The students rate there courses pretty high***
    Is this what you expected to see?
    Why, or why not?
    ***I did expect to see some good responses for most professors so this data did not surprise me***
...
***There is a slight increase in evaluation score based on beauty rating.***
...
3.  Recreate the scatterplot from Exercise 2, but this time use\
    ...
    ***Jitter means that it adds a little bit of space in between point so you can see that there are several points that might fall around the same place. What could be misleading is that you don't know how many fall at that specific place.***
...
***For an average beauty increased by one the average evaluation rating goes up by 0.07***
...
***For an average beauty rating of zero the average evaluation rating is 3.88. This doesn't make sense in the data for there is no beauty ratings that are zero***
...
***A male professor subject on average scores 0.14 higher on evaluations then a female professor.***
***On average a female professor score 4.09 on ratings***
...
***The model is***
***score= 4.28 -0.12 - Tenure Track 0.14 x tenure***

***The average rating for a teaching track professor is 4.28. The average track for a tenure track is 0.12 lower than a teaching track professor. The average rating for a tenure track professor is 0.14 points lower than a teaching professor.***
...
```
***The model is***
$$/widehat{score}=4.14 + 0.14/ times teaching + 0.2/ times Tenur track$$
***The average rating for a tenured track professor is 4.14. The average rating for a teaching track professor is 0.14 points higher then a tenured track. The average for a tenure track professor is 0.02 higher than a tenured professor.***
